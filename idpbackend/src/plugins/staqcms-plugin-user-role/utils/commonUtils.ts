...
export const commonUtils = {
	deleteUndefinedFieldsInObject: function (jsObj: any) {
		...
		for (let key in Object.keys(jsObj)) {
	...
	sendResponse: function (res: Response, status: number, success: boolean, data: unknown | null | undefined, message: string): void {
		let responseData = { success, data, message };
